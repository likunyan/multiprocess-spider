...
if total_text_lines%text_lines == 0:
    ...
    number_of_tasks = (total_text_lines/text_lines)+1           # 有余数的时候，需要多安排一个任务
...
def open_text_file(i,start_line, end_line):
    ...
    for text_line in open('data.txt').readlines()[start_line:end_line]:  # 轮询源文件中的网址
